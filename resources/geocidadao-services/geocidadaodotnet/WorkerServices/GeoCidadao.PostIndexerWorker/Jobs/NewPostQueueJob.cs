...
{
    public class NewPostQueueJob(ILogger<NewPostQueueJob> logger, INewPostQueueService service) : BaseJob(logger), IJob
    {
        private readonly INewPostQueueService _service = service;
