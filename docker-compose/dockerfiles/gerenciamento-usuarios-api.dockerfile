...
WORKDIR /src
COPY resources/geocidadao-services/geocidadaodotnet/GeoCidadao.GerenciamentoUsuariosAPI/GeoCidadao.GerenciamentoUsuariosAPI.csproj GeoCidadao.GerenciamentoUsuariosAPI/
